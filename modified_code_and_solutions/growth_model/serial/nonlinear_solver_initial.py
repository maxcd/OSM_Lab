...
def initial(k_init, n_agents, thet):
    ...
    def eval_f(X):
        return EV_F(X, k_init, n_agents, thet)

    def eval_grad_f(X):
        return EV_GRAD_F(X,k_init, n_agents, thet)

    def eval_g(X):
        return EV_G(X, k_init, n_agents, thet)

    def eval_jac_g(X, flag):
        return EV_JAC_G(X, flag, k_init, n_agents, thet)
